...
.columnwide[
  ...
  ### 4) [Predictive Modeling: regression and Relatives](#PredictiveModeling)
  ### 5) [PLS and PLS-LDA](#PLS)
  ### 6) [Performance assessment in class prediction](#ClassPredictionProcess)

  <!-- ### 6) [Supervised learning](#Supervised) -->
  <!-- ### 7) [Summary and Conclusions](#Summary) -->
  ### 7) [References and Resources](#Resources)
]
...
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_13.png")
```
...
![Plot title. ](2-MultivariateStat-and-ML_insertimage_14.png)
...
```{r, fig.align='center', out.width='60%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_15.png")
```
...
# Alternatives for predicive models
...
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_16.png")
```
...
```{r, fig.align='center', out.width='90%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_17.png")
```
...
```{r, fig.align='center', out.width='90%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_18.png")
```
...
```{r, fig.align='center', out.width='90%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_20.png")
```
...
```{r, fig.align='center', out.width='90%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_19.png")
```
...
```{r, fig.align='center', out.width='60%', fig.cap='', echo=FALSE}
knitr::include_graphics("2-MultivariateStat-and-ML_insertimage_21.png")
```
...
.pull-right[
![Plot title. ](2-MultivariateStat-and-ML_insertimage_22.png)
]
